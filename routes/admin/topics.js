...
router.post('/', authMiddleware, async (req, res) => {
    ...
    let query = db.select({ ...selectFeilds, "status": "tbl_topic.status", "topic_id": "topic_id" }).from("tbl_topic").innerJoin('tbl_category', 'tbl_category.category_id', 'tbl_topic.category_id');
