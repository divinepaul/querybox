...
export default function AdminFiles() {
    ...
    const [sortBy, setSortBy] = useState('file_id');
    ...
    useEffect(() => {
        (async () => {
            ...
            let [res, data] = await requestWithAuth(navigate, "/api/admin/files/",
    ...
    let printPDF = async () => {
        const doc = new jsPDF()
        doc.setFontSize(22);
        doc.text("QUERYBOX FILES REPORT", 10, 20);
        doc.setFontSize(13);
