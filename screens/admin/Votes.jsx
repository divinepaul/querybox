...
export default function AdminVotes() {
    ...
    const [sortBy, setSortBy] = useState('vote_id');
    ...
    useEffect(() => {
        (async () => {
            ...
            let [res, data] = await requestWithAuth(navigate, "/api/admin/votes/",
    ...
    let printPDF = async () => {
        const doc = new jsPDF()
        doc.setFontSize(22);
        doc.text("QUERYBOX VOTES REPORT", 10, 20);
        doc.setFontSize(13);
